...
public class TypicalPersons {
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withRemark("").withPhone("9482442")
    ...
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_BOB)
            .withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB).withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withRemark("")
            .build();
